...
config file):
	...
	HiddenServicePort 7475 127.0.0.1:7475
	HiddenServicePort 16745 127.0.0.1:16745

The directory can be different of course, but (both) port numbers should be equal to
your litecoind's P2P listen port (7475 by default).
...
and open port 7475 on your firewall (or use -upnp).
